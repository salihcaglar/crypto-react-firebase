        ...
        <div className="text-right">
          <div className="w-full flex justify-end">
            <div className="w-full md:w-[300px] py-4 relative">
              ...
              <p className="text-center md:text-right">Sign up for cyrpto news</p>
              <div className="py-4">
                <form>
                  ...
                  <button className="bg-button text-btn-Text px-4 p-2 2-full rounded shadow-xl hover:shadow-wxl dm:w-auto my-2">Sign up</button>
                </form>
              </div>
