...
const CoinPage = () => {
  ...
  return (
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div>
          <div className="flex justify-between ">
            ...
            <p className="text-3xl font-bold">7 Day</p>
          </div>
          <div>
          ...
          <div className="flex justify-between py-4">
            ...
            <div>
              <p className="text-gray-500 text-sm">Value (24h)</p>
          ...
          <div className="flex justify-between ">
            <div>
              <p className="text-3xl font-bold">24h High</p>
              {coin?.market_data?.high_24h ? <p>${coin.market_data.high_24h.usd.toLocaleString()}</p> : null}
            </div>
            <div>
              <p className="text-3xl font-bold">24h Low</p>
        ...
        <div>
          ...
          <div className="flex justify-between py-4">
            ...
            <div>
              <p className="text-gray-500 text-sm">high_24h</p>
    ...
    </div> : <div className="flex justify-center items-center h-[300px] pt-10"> <img style={{backgroundColor:"white"}} className="bg-[#fff]" src={Spinner} alt="/" /> </div>}
    </>
  );
};
